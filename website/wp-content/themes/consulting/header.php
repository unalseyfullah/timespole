...
<head>
	...
	<script>
          ...
          })(window,document,'script','//www.timespole.com/assets/js/analytics.js','ga');
          ga('create', 'UA-37969829-1', 'auto');
          ga('send', 'pageview');
        </script>
</head>
<body <?php body_class(); ?>>
						...
						<div class="top_bar">
							<div class="container">
								<?php if( consulting_get_header_style() == 'header_style_6' ) : ?>
									...
									<?php
										if ( get_theme_mod( 'wpml_switcher', true ) ) {
											if(stm_check_dev()): ?>
												<div id="lang_sel" class="icl_rtl"><ul><li><a href="#" class="lang_sel_sel icl-he">עברית</a> <ul><li class="icl-en"><a href="#">אנגלית</a></li></ul></li></ul></div>
											<?php
											else:
								...
								<?php else : ?>
									...
									if ( get_theme_mod( 'wpml_switcher', true ) ) {
										if(stm_check_dev()): ?>
											<div id="lang_sel" class="icl_rtl"><ul><li><a href="#" class="lang_sel_sel icl-ar">العربية</a> <ul><li class="icl-en"><a href="#">الإنجليزية</a></li></ul></li></ul></div>
										<?php else :
											do_action( 'wpml_add_language_selector' );
										endif;
									}
