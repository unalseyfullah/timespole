...
if ( ! function_exists( 'consulting_vc_elements' ) ) {
	function consulting_vc_elements() {
		...
		if(stm_check_layout('layout_18')) {
			vc_map( array(
				'name'        => esc_html__( 'Pricing Plan', 'smarty' ),
				...
				'params'      => array(
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Plan title', 'smarty' ),
						'param_name' => 'title'
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Plan price', 'smarty' ),
						'param_name' => 'price'
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Plan price affix', 'smarty' ),
						'param_name' => 'price_affix'
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Plan subtitle', 'smarty' ),
						'param_name' => 'subtitle'
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Plan label', 'smarty' ),
						'param_name' => 'label'
					),
					array(
						'type'       => 'textarea_html',
